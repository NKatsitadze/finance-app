...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden background-beige-100 p-4 gap-10" style={{border:'1px solid red'}}>

      <div className="hidden overflow-hidden items-center flex md:block md:w-2/5 rounded-xl relative">
        <img
          src={loginImage.src}
          alt="login image"
      ...
      <div className="w-full md:w-3/5 flex items-center justify-center ">
        <div className="bg-white p-8 flex flex-col gap-8 rounded-xl shadow-md w-full max-w-[560px]">
